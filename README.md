# 🍽️ Bowdoin College Dining Hall Menu Bot
...
- Collects menu data one hour before each meal period and sends formatted messages to GroupMe automatically
- Separates messages by dining hall for easy readability
